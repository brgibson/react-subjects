...
describe('when <Tabs> is rendered', () => {
  ...
  it('activates the first tab', () => {
      expect(tabs[0].style['border-bottom-color']).toEqual(borderFixture.style['border-bottom-color'])
  })

  it('does not activate the second tab', () => {
      expect(tabs[1].style['border-bottom-color']).toNotEqual(borderFixture.style['border-bottom-color'])
  })
  ...
  describe('after clicking the second tab', () => {
    ...
    it('activates the second tab', () => {
        expect(tabs[1].style['border-bottom-color']).toEqual(borderFixture.style['border-bottom-color'])
    })

    it('deactivates the first tab', () => {
        expect(tabs[0].style['border-bottom-color']).toNotEqual(borderFixture.style['border-bottom-color'])
    })
